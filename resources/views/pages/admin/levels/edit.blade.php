...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.levels.update', $laLevel->id) }}" id="languageForm"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4  mg-b-20">
                                ...
                                <input type="text" name="mission_points" value="{{ $laLevel->mission_points }}"
                                    class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                    required>
                            </div>
                            <div class="col-md-4  mg-b-20">
                                <h6>Quiz Points<span class="text-danger">*</span></h6>
                                <input type="text" name="quiz_points" value="{{ $laLevel->quiz_points }}"
                                    class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                    required>
                            </div>
                            <div class="col-md-4  mg-b-20">
                                <h6>Puzzle Points<span class="text-danger">*</span></h6>
                                <input type="text" name="puzzle_points" value="{{ $laLevel->puzzle_points }}"
                                    class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                    required>
                            </div>
                            <div class="col-md-4  mg-b-20">
                                <h6>Riddle Points<span class="text-danger">*</span></h6>
                                <input type="text" name="riddle_points" value="{{ $laLevel->riddle_points }}"
                                    class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                    required>
                            </div>
                            <div class="col-md-4  mg-b-20">
                                <h6>Jigyasa Points<span class="text-danger">*</span></h6>
                                <input type="text" name="jigyasa_points" value="{{ $laLevel->jigyasa_points }}"
                                    class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                    required>
                            </div>
                            <div class="col-md-4  mg-b-20">
                                <h6>Pragya Points<span class="text-danger">*</span></h6>
                                <input type="text" name="pragya_points" value="{{ $laLevel->pragya_points }}"
                                    class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                    required>
                            </div>
                            <div class="col-md-4  mg-b-20">
                                <h6>Quiz Timing<span class="text-danger">*</span></h6>
                                <input type="text" name="quiz_time" value="{{ $laLevel->quiz_time }}"
                                    class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                    required>
                            </div>
                            <div class="col-md-4  mg-b-20">
                                <h6>Puzzle Timing<span class="text-danger">*</span></h6>
                                <input type="text" name="puzzle_time" value="{{ $laLevel->puzzle_time }}"
                                    class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                    required>
                            </div>
                            <div class="col-md-4  mg-b-20">
                                <h6>Riddle Timing<span class="text-danger">*</span></h6>
                                <input type="text" name="riddle_time" value="{{ $laLevel->riddle_time }}"
                                    class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                    required>
                            </div>
                                        ...
                                        @foreach ($laLevel->title as $key => $title)
                                            <tr data-repeater-item="">
                                                ...
                                                <td> <input type="text" class="form-control" id="title"
                                                        ...
                                                        value="{{ $title }}" autocomplete="off" required></td>
                                                <td> <input type="text" class="form-control" id="description"
                                                        name="description" placeholder="Enter Description"
                                                        value="{{ $laLevel->description[$key] ?? null }}"
                                                        autocomplete="off" required></td>
                                                <td><input data-repeater-delete="" type="button"
