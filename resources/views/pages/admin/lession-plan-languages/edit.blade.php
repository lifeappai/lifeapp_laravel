...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.lession.plan.languages.update', $laLessionPlanLanguage->id) }}" id="languageForm"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6  mg-b-20">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{ $laLessionPlanLanguage->name }}" placeholder="Enter Language" required=""
                                    autocomplete="off">
                            </div>
