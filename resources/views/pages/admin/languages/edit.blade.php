...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.languages.update', $language->id) }}" id="languageForm"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6  mg-b-20">
                                ...
                                <select name="slug" class="form-control" required>
                                    ...
                                    @foreach ($languages as $key => $languageData)
                                        <option value="{{ $key }}"
                                            @if ($language->slug == $key) selected @endif>{{ $languageData }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-12">
